          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="门禁型号:" prop="e_model">
                <el-input v-model="deviceInfoForm.e_model"></el-input>
              </el-form-item>
              <el-form-item label="Ups:" prop="e_UPSInfo">
                <el-input v-model="deviceInfoForm.e_UPSInfo"></el-input>
              </el-form-item>
              <el-form-item label="Nvr:" prop="e_NVRInfo">
                <el-input v-model="deviceInfoForm.e_NVRInfo"></el-input>
              </el-form-item>
              <el-form-item label="掉电自启模块:" prop="e_embeddedModuleInfo">
                <el-input v-model="deviceInfoForm.e_embeddedModuleInfo"></el-input>
              </el-form-item>
              <el-form-item label="服务器:" prop="e_serverInfo">
                <el-input v-model="deviceInfoForm.e_serverInfo"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="交换机:" prop="e_switchInfo">
                <el-input v-model="deviceInfoForm.e_switchInfo"></el-input>
              </el-form-item>
              <el-form-item label="电视机:" prop="e_televisionInfo">
                <el-input v-model="deviceInfoForm.e_televisionInfo"></el-input>
              </el-form-item>
              <el-form-item label="Pdu:" prop="e_PDUInfo">
                <el-input v-model="deviceInfoForm.e_PDUInfo"></el-input>
              </el-form-item>
              <el-form-item label="路由器:" prop="e_routerInfo">
                <el-input v-model="deviceInfoForm.e_routerInfo"></el-input>
              </el-form-item>
              <el-form-item label="4g无线路由器:" prop="e_LTERouterInfo">
                <el-input v-model="deviceInfoForm.e_LTERouterInfo"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
